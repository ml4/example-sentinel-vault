...
You current are recommended to test this repo with sentinel0.19.2-rc1. A known issue exists 0.19.1.  Credence to the HashiCorp Sentinel product, engineering and education teams.
