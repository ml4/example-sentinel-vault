...
Go into the Vault ACL policies directory and apply the basic Vault ACL policy to Vault to allow token-holders to write to the path.
Most command line responses are not shown for brevity.
