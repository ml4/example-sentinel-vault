...
If following this whole README, go into the Vault ACL policies directory and _log back in with a privileged token_. Apply the business-policy to Vault to allow token-holders to read from an Accounting team path. Write such a path:
