...
Go into the Vault ACL policies directory, _log back in with a privileged token_ and apply the policy to Vault to allow token-holders to read from an Accounting team path. Write such a path:
